...
const reviewersNotes: Note[] = [
  ...
  },
  {
    ...
    reviewer: "Ms. Titi Alabi (Admissions Officer)",
    notes:
  ...
  {
    dateTime: "2025-10-21, 10:05 AM",
    reviewer: "System Bot",
    notes:
      "Application Status changed from Under Review to Approved. Acceptance letter generated and sent to Parent Email.",
  },
];
