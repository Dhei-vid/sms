...
export function EditCanteenItemForm({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="space-y-6 py-4">
      ...
      <SelectField
        ...
        onValueChange={(value) =>
          setFormData((prev) => ({ ...prev, selectItem: value }))
        }
      ...
      <InputField
        ...
        type="number"
        value={formData.initialUnitPrice}
        onChange={(e) =>
          setFormData((prev) => ({
            ...prev,
