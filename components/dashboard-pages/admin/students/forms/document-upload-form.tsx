...
import type { StudentDocumentsState } from "./student-edit-form-state";
...
export function StudentDocumentUploadForm({
  ...
  value: StudentDocumentsState;
  onChange: (next: StudentDocumentsState) => void;
  onNext: () => void;
  onBack: () => void;
  onCancel: () => void;
}) {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600">
        Optional. Select files to add or replace documents. Only newly selected
