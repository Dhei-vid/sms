...
const tabs: Tab[] = [
  { id: "snapshot", label: "Request Snapshot", icon: User03Icon },
  { id: "details", label: "Request Details", icon: DocumentValidationIcon },
  { id: "policy", label: "Policy Check", icon: DocumentValidationIcon },
];
